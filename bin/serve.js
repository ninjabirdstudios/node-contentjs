...
/// project_name
///  |=> database    (this is your content database directory)
///  |=> packages    (this is your content packages directory)
///  |=> processors  (this is your content processors directory)
///  |=> publish     (this is your publish directory)
///  |=> staging     (this is your staging directory)
///  |=> web         (this is your static web content directory)
///  ----|=> images  (static image files, not game content)
///  ----|=> scripts (game code)
